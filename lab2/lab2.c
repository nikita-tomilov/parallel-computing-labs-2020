...
int main(int argc, char *argv[]) {
    ...
    for (i = 0; i < 50; i++) /* 50 экспериментов */
    {
		...
		//для начального элемента массива предыдущий элемент равен нулю
		fwsAdd_64f(M2, M2_copy, M2, N/2);
		fwsLog10_64f_A53(M2, M2, N/2);
		fwsPowx_64f_A53(M2, e, M2, N/2);

        //этап Merge
		//Модуль разности
		fwsSub_64f(M2, (M2_copy + 1), M2, N/2);
		fwsAbs_64f_I(M2, N/2);
