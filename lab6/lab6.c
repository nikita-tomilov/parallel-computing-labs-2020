...
size_t source_size;
char *source_str;
const int g_cuNumItems = 10;

void createProgram() {
    const char fileName[] = "/mnt/c/shared/parallel-computing-labs-2020/lab6/testdevice.cl";
...
int main() {
    ...
    cl_kernel kernel = clCreateKernel(program, "f", &ret);
    printf("clCreateKernel ret %d\n", ret);

//    cl_mem buffer = clCreateBuffer(
//            context,
//            CL_MEM_WRITE_ONLY,
//            g_cuNumItems * sizeof(cl_uint),
//            NULL,
//            &ret);
//    printf("clCreateBuffer ret %d\n", ret);

    //clSetKernelArg(kernel, 0, sizeof(buffer), (void *) &buffer);

    cl_mem M1_clmem = clCreateBuffer(context, CL_MEM_READ_ONLY, g_cuNumItems * sizeof(float), NULL, &ret);
    ...
    ret = clEnqueueWriteBuffer(queue, M1_clmem, CL_TRUE, 0, g_cuNumItems * sizeof(float), M1, 0, NULL, NULL);
